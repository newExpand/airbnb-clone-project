...
const ListingClient: React.FC<ListingClientProps> = ({
        ...
        IMP.request_pay(
            {
                ...
                m_redirect_url: `https://clone-example-three.vercel.app/listings/${listing.id}?totalPrice=${totalPrice}&startDate=${dateRange.startDate}&endDate=${dateRange.endDate}`,
            },
            (rsp: any) => {
                if (rsp.success) {
                    axios
    ...
    useEffect(() => {
        if (
            ...
            axios
                .post("/api/reservations", {
                    totalPrice: Number(totalPriceM),
                    startDate: new Date(startDateM as string),
                    endDate: new Date(endDateM as string),
                    listingId: listing?.id,
                    merchant_uid: merchant_uidM,
                })
                .then(() => {
