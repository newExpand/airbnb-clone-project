...
const Search = () => {
    ...
    const locationLabel = useMemo(() => {
        if (locationValue) {
            ...
            return `${location?.label} (${location?.translations})`;
        }
    ...
    return (
        <div
            ...
            className="border-[1px] w-full md:w-auto md:ml-2 py-2 rounded-full shadow-sm hover:shadow-md transition cursor-pointer"
        >
